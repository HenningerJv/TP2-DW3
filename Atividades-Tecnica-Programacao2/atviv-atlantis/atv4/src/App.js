...
import ListarAcomodacoesSemCliente from './pages/ListarAcomodacaoSemCliente';
import AlocarClienteAcomodacao from './pages/AlocarClienteAcomodacao';
    ...
    <Router>
      <div>
        <Routes>
          ...
          {/* Acomodar */}
          <Route exact path="/listarAcomodacoesSemCliente" element={<ListarAcomodacoesSemCliente/>} />
          <Route exact path="/alocarCliente/:idAcomodacao" element={<AlocarClienteAcomodacao/>} />
        </Routes>
      </div>
    </Router>
  );
